<?php session_start(); 
	 ...
	 {	 
	     ...
	     $today = date("Y-m-d");
		 $awal = date("Y-m-d",mktime(0,0,0,10,1,2012));
		 $akhir = date("Y-m-d",mktime(0,0,0,10,21,2012));
		 $show=0;
		 if(($awal<$today) and ($today<$akhir) )
		 {
		  $show=1;
		 }
...
<body>
   ...
   <!-- ui-dialog -->
	...
	<?php } else { echo "<p>Massa pengisian Kartu Rencana Studi (KRS) sudah berakhir.<br> Bagi yg belum mengisi harap hubungi Tata Usaha. </p>"; } ?>	
	</div>	
