...
function add1_click(thn) {

	var my_ajax = new myajax;
	my_ajax.url = "../global_class/chg_conten.php";
	my_ajax.data = "thn="+thn+"&idx=47";
	my_ajax.success = function success(data) {
		$("#data").html(data);
		update_stat();
	};
