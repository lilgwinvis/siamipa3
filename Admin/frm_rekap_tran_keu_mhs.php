...
<head>
    <title>Rekap Transaksi Keuangan Mahasiswa</title>
	...
	<script type="text/javascript" src="local_js/frm_rekap_tran_keu_mhs.js"></script>
...
<body>
   ...
   <!-- ui-dialog -->
		<div id="dialog" title="Rekap Transaksi Keuangan Mahasiswa">
		  <?php 
		     
             $vwrekapkeumhs = new vwrekapkeumhs;
		    
		       echo $vwrekapkeumhs->tbl_rekap();
