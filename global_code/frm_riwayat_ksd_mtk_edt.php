...
<head>
    <title>Riwayat Kesediaan Ngajar : Edit Riwayat Jadwal</title>
	...
	<script type="text/javascript" src="local_js/frm_riwayat_ksd_mtk_edt.js"></script>
...
<body>
   ...
   <!-- ui-dialog -->
	<div id="dialog" title="Riwayat Kesediaan Ngajar : Edit Riwayat Jadwal">	
	    <?php echo $ksd_ngajar->edt_riwayat_jadwal($kode,1,$thn) ?>
	</div>	 
</body>
