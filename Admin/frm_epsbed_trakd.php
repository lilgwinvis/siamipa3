...
<head>
	...
	<script type="text/javascript" src="local_js/frm_epsbed_trakd.js"></script>
...
<body>
   ...
   <!-- ui-dialog -->
		<div id="dialog" title="Aktivitas Dosen">
		  <?php 
		   $vwepsbedtrakd = new vw_epsbed_trakd;
		   echo $vwepsbedtrakd->sem_filter(); 
		  ?> 
		</div>
