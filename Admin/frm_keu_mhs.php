<?php 
	 ...
	 else
	 {
	   ...
	   $_SESSION['pg_bfr']="../Admin/frm_keu_mhs.php";
...
<head>
    <title>Kewajiban Permahasiswa</title>
	...
	<script type="text/javascript" src="local_js/frm_keu_mhs.js"></script>
	...
	$(document).ready(function () {
		...
		$("#Add").click(function () {
			...
			var thnmsmshs = $("#Angkatan").val();
			var kelas = $("#kls").val();
			window.parent.buka_dlg("frm_keu_mhs_entry.php?idx=1&nim=" + nim + "&thn=" + thnmsmshs + "&kls=" + kelas);
		});
		...
		$("#Edit").click(function () {
			...
			if (anSelected.length !== 0) {
				...
				$data = $data + '&idx=2';
				window.parent.buka_dlg("frm_keu_mhs_entry.php?" + $data);
			} else {
		...
		$("#Del").click(function () {
			...
			var thnmsmshs = $("#Angkatan").val();
			var kelas = $("#kls").val();
			window.parent.buka_dlg("frm_keu_mhs_entry.php?idx=3&nim=" + nim + "&thn=" + thnmsmshs + "&kls=" + kelas);
		});
...
<body>
   ...
   <!-- ui-dialog -->
		<div id="dialog" title="Kewajiban Permahasiswa">
		   <?php 
		     echo $vwkeumhs->filter_mhs($thn,$kls,$nim);
		   ?>
		</div>
