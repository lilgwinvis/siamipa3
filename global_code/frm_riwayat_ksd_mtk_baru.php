<?php require_once 'shared.php'; 
	 ...
	 {	  
		  ...
		  $data = $dtksd_ngajar->getRiwayatSebaranData($kode,$thn);
?>
...
<head>
    <title>Riwayat Kesediaan Ngajar : Ngajar Matakuliah</title>
	...
	<script type="text/javascript" src="local_js/frm_riwayat_ksd_mtk_baru.js"></script>
...
<body>
   ...
   <!-- ui-dialog -->
	<div id="dialog" title="Riwayat Kesediaan Ngajar : Ngajar Matakuliah">	
	    <?php echo $ksd_ngajar->build_riwayat_ksd($kode,$thn) ?>
	</div>	
</body>
