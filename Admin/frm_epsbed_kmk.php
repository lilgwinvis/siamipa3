...
<head>
	...
	function init_tb()
	{
	  oTable=$("#lst_epsbedkmk").dataTable();
	...
	function update_stat()
	{
	  ...
	  $.ajax({
									 ...
									 success : function(data){
					                            $("#stat").html(data);
												 init_tb();
												 $("#stat1_epsbedtbkmk").dataTable({"aaSorting": []});
												}
                                  });
	}
...
<body>
   ...
   <!-- ui-dialog -->
		<div id="dialog" title="Kurikulum">
		  <?php 
		   $vwepsbedkmk = new vw_epsbed_kmk;
		   echo $vwepsbedkmk->sem_filter(); 
		  ?> 
		</div>
