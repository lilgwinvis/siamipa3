<?php require_once 'shared.php';
	 ...
	 {	  
		  ...
		  $data = $dtksd_ngajar->getSebaranData($kode,1);
?>
...
<head>
    <title>Kesediaan Ngajar : Ngajar Matakuliah Baru</title>
	...
	<script type="text/javascript" src="local_js/frm_ksd_mtk_baru.js"></script>
...
<body>
   ...
   <!-- ui-dialog -->
	<div id="dialog" title="Kesediaan Ngajar : Ngajar Matakuliah Baru">	
	    <?php echo $ksd_ngajar->build_ksd($kode,1) ?>
	</div>	
</body>
