<?php require_once 'shared.php';
	 ...
	 {	  
		  ...
		  $data = $dtksd_ngajar->getDataMtk($kode);
?>
...
<head>
    <title>Kesediaan Mengajar : Hapus Kesediaan</title>
...
<script type="text/javascript" src="../js/siamipa.js"></script>
	<script type="text/javascript" src="local_js/frm_ksd_mtk_hapus.js"></script>	
...
<body>
   ...
   <!-- ui-dialog -->
	<div id="dialog" title="Kesediaan Mengajar : Hapus Kesediaan ">	
	   <?php echo $ksd_ngajar->edt_jadwal($kode,0) ?>
	</div>	 
</body>
