...
<head>
    <title>Nilai Konversi: Edit HM </title>
	...
	<script type="text/javascript" src="../Admin/local_js/frm_trnlp_mtk_edit.js"></script>
...
<body>
   ...
   <!-- ui-dialog -->
	<div id="dialog" title="Nilai Konversi : Edit HM ">	
	    <?php echo $lht_trnlp->build_trnlp($nim,0) ?>
	</div>	 
</body>
