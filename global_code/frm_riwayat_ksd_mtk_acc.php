...
<head>
    <title>Riwayat Kesediaan Mengajar : Honor</title>
	...
	<script type="text/javascript" src="local_js/frm_riwayat_ksd_mtk_acc.js"></script>
...
<body>
   ...
   <!-- ui-dialog -->
	<div id="dialog" title="Riwayat Kesediaan Mengajar : Honor ">	
	   <?php echo $ksd_ngajar->edt_riwayat_jadwal($kode,2,$thn) ?>
	</div>	 
</body>
