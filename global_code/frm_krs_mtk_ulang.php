<?php require_once 'shared.php'; 
	 ...
	 {	  
          ...
          $data = $vbuild_krs->buildkrs($nim,0);
		if(!empty($data)){ 
		   foreach ($data as $row) {		
...
<head>
	...
	<script type="text/javascript" src="local_js/frm_krs_mtk_ulang.js"></script>
...
<body>
   ...
   <!-- ui-dialog -->
	<div id="dialog" title="Kartu Rencana Studi &#40KRS&#41 : Mengulang Matakuliah ">	
	    <?php echo $build_krs->build_krs($nim,0) ?>
	</div>	 
</body>
