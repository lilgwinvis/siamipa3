...
<head>
	...
	<script type="text/javascript" src="local_js/frm_epsbed_msmhs.js"></script>
	...
	$(document).ready(function () {
		...
		$("#Add").click(function () {
			var thn = $("#Angkatan").val();
			var tmp = $('#Angkatan').find('option:selected').text();
...
<body>
   ...
   <!-- ui-dialog -->
		<div id="dialog" title="Master Mahasiswa">
		  <?php 
		   $vwepsbedmsmhs = new vw_epsbed_msmhs;
		   echo $vwepsbedmsmhs->lst_mhs(); 
		  ?> 
		</div>
