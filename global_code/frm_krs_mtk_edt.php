<?php require_once 'shared.php'; 
	 ...
	 {	  
          ...
          $data = $vbuild_krs->getData("nimhskrs='$nim'");
?>
...
<head>
	...
	<script type="text/javascript" src="local_js/frm_krs_mtk_edt.js"></script>
...
<body>
   ...
   <!-- ui-dialog -->
	<div id="dialog" title="Kartu Rencana Studi &#40KRS&#41 : Edit Kelas ">	
	    <?php echo $lht_krs->olah_krs($nim) ?>
	</div>	 
</body>
