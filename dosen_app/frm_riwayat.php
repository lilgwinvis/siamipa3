<?php require_once 'shared.php';     
	 ...
	 $_SESSION['pg_bfr']="../dosen_app/frm_riwayat.php";
	 if($islog==0)
	 {
...
<head>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><link type="text/css" href="../css/jquery-ui-1.8.23.custom.css" rel="stylesheet" />
   ...
   <!-- ui-dialog -->
		...
		<div id="dialog" title="Riwayat Mengajar">
			...
			<!--<div id="accordion">-->
			 ...
			 <div id="data"> 
				  <?php
				    $vwriwayat=new vwriwayat;
					echo $vwriwayat->buildriwayat($kode,3);
				  ?>
		     </div>
			 </fieldset>
		     <!--</div>-->
