...
<head>
    <title>Kesediaan Mengajar : Setujui+Honor</title>
	...
	<script type="text/javascript" src="local_js/frm_ksd_mtk_acc.js"></script>
...
<body>
   ...
   <!-- ui-dialog -->
	<div id="dialog" title="Kesediaan Mengajar : Setujui+Honor ">	
	   <?php echo $ksd_ngajar->edt_jadwal($kode,2) ?>
	</div>	 
</body>
