<?php require_once 'shared.php';
	 ...
	 {	  
		  ...
		  $data = $vbuild_trnlm->buildkrs($nim,$thnsms,1);
		  $kode_matkul=array();
		if(!empty($data)){ 
		 foreach ($data as $row) {	
...
<head>
	...
	<script type="text/javascript" src="local_js/frm_riwayat_krs_mtk_baru.js"></script>
...
<body>
   ...
   <!-- ui-dialog -->
	<div id="dialog" title="Riwayat Kartu Rencana Studi &#40KRS&#41 - <?php echo $tmp_txt ?> : Ambil Matakuliah Baru ">	
	    <?php echo $build_krs->build_krs($nim,$thnsms,1) ?>
	</div>	
</body>
