...
<head>
    <title>Kesediaan Ngajar : Edit Jadwal</title>
	...
	<script type="text/javascript" src="local_js/frm_ksd_mtk_edt.js"></script>
...
<body>
   ...
   <!-- ui-dialog -->
	<div id="dialog" title="Kesediaan Ngajar : Edit Jadwal">	
	    <?php echo $ksd_ngajar->edt_jadwal($kode) ?>
	</div>	 
</body>
