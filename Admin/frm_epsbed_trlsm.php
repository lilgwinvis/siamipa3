...
<head>
    <title>Mahasiswa Lulus/Cuti/Non-Aktif</title>
...
<body>
   ...
   <!-- ui-dialog -->
		<div id="dialog" title="Mahasiswa Lulus/Cuti/Non-Aktif">
		  <?php 
		   $vwepsbedtrlsm = new vw_epsbed_trlsm;
		   echo $vwepsbedtrlsm->sem_filter(); 
		  ?> 
		</div>
