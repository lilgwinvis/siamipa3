...
<head>
    <title>Kartu Rencana Studi (KRS): Edit Kelas </title>
	...
	<script type="text/javascript" src="local_js/frm_riwayat_krs_mtk_edt.js"></script>	
...
<body>
   ...
   <!-- ui-dialog -->
	<div id="dialog" title="Riwayat Kartu Rencana Studi &#40KRS&#41 - <?php echo $tmp_txt ?> : Edit Kelas ">	
	    <?php echo $lht_krs->olah_krs($nim,$thnsms) ?>
	</div>	 
</body>
