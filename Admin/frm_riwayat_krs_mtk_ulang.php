<?php 
	 ...
	 {	  
		  ...
		  $build_krs = new vw_riwayat_krs;
		  $vbuild_trnlm = new dt_trnlm;
          $data = $vbuild_trnlm->buildkrs($nim,$thnsms,0);
		if(!empty($data)){ 
		   foreach ($data as $row) {		
...
<head>
    <title>Kartu Rencana Studi (KRS): Mengulang Matakuliah </title>
	...
	<script type="text/javascript" src="local_js/frm_riwayat_krs_mtk_ulang.js"></script>
...
<body>
   ...
   <!-- ui-dialog -->
	<div id="dialog" title="Riwayat Kartu Rencana Studi &#40KRS&#41 - <?php echo $tmp_txt ?> : Mengulang Matakuliah ">	
	    <?php echo $build_krs->build_krs($nim,$thnsms,0) ?>
	</div>	 
</body>
