<?php 
  require_once 'shared.php';
   ...
   $menu = array("Riwayat Ngajar & Nilai"=>array(0=>"Riwayat Mengajar",1=>"Nilai Belum Masuk"),
                 "Kesediaan Ngajar"=>array(2=>"Kesediaan Ngajar"),
				 "Informasi Akademik"=>array(3=>"Sebaran Matakuliah",4=>"Jadwal Kuliah"),
				 "Menu User"=>array(5=>"User Profile",6=>"Ganti Password",7=>"Logout"));
...
<head>
	...
	function init_app() {
		window.frames['mainFrame'].location.replace("../dosen_app/frm_riwayat.php");
	}
...
<body style="position: relative; height: 100%; overflow: hidden; margin: 0px; padding: 0px; border: medium none;" class="ui-layout-container">
	...
	<div class="ui-layout-north ui-widget-content ui-layout-pane ui-layout-pane-north" style="display: block; position: absolute; margin: 0px; top: 0px; bottom: auto; left: 0px; right: 0px; width: auto; z-index: 0; height: 100%; visibility: visible;">
	 <center> <span style="color:gold"><h3>Sistem Informasi Akademik<h3> 
	...
	<iframe style="position: absolute; margin: 0px; left: 0px; right: 0px; top: 0px; bottom: 0px; height: 100%; width: 100%; z-index: 0; display: block; visibility: visible;" id="mainFrame" name="mainFrame"  src="../global_code/frm_login.php?idx=3" frameborder="0" height="100%" scrolling="auto" width="100%">
