<?php require_once 'shared.php'; 
	 ...
	 {	  
		  ...
		  $data = $dtksd_ngajar->getSebaranData($kode,0);
?>
...
<head>
    <title>Kesediaan Ngajar : Ngajar Matakuliah Lama</title>
	...
	<script type="text/javascript" src="local_js/frm_ksd_mtk_ulang.js"></script>
...
<body>
   ...
   <!-- ui-dialog -->
	<div id="dialog" title="Kesediaan Ngajar : Ngajar Matakuliah Lama">	
	   <?php echo $ksd_ngajar->build_ksd($kode,0) ?>
	</div>	 
</body>
